...
/* CHANGED TO BELOW VALUES FOR SOFTER START AND END
...
#define SERVO_RIGHT_STOP (uns16)3510  // 3750 ticks for 1.5 ms
#define SERVO_2MS	(uns16)5000  // 5000 ticks for 2 ms
*/

#define SERVO_1MS	(uns16)3250  // 2500 ticks for 1 ms
#define SERVO_LEFT_STOP	(uns16)3750  // 3750 ticks for 1.5 ms
#define SERVO_RIGHT_STOP (uns16)3510  // 3750 ticks for 1.5 ms
#define SERVO_2MS	(uns16)4250  // 5000 ticks for 2 ms
